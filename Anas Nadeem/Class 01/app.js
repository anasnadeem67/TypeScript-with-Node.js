...
const titlecasename = myname.replace(/\b\w/g, (match) => match.toUpperCase());
...
const msg2 = `My favorite number is ${favoritenumber}. `;
console.log(msg2);
// Name Program
// Author: Anas Nadeem
// Date: 25 November 2023
// Storing names in an array
const names = ["Abdurrehman", "Ahad", "Hussam", "Ali"];
...
// Author: Anas Nadeem
// Date: 25 November 2023
const favoritetransportation = ["Tesla Modell S", "Honda Motorcycle", "Toyota Prius", "BMW X5"];
...
const guestList = ["Ali", "Hussam", "Faisal"];
...
const guestCannotMakeIt = "Faisal";
...
const newGuest = "Taha";
const updatedGuestList = [...guestList.filter(guest => guest !== guestCannotMakeIt), newGuest];
...
// Storing the original list of people to invite to dinner
// Storing the guest who can't make it
const guestCannotMakeIt2 = "Faisal";
// Informing about the bigger dinner table
console.log("Good news! We found a bigger dinner table.\n");
// Adding new guests to the array
const newGuests = ["Fahad", "Yasir"];
const updatedGuestList2 = [
...
// Date: 25 November 2023
// Storing the original list of people to invite to dinner
const originalGuestList = ["Ali", "Hussam", "Faisal", "Taha", "Ibad"];
...
const programmingLanguages = ["JavaScript", "Python", "Java", "TypeScript", "C#", "Ruby", "Go"];
...
const usernames = ['admin', 'Faisal', 'Riaz', 'Kamran', 'Zubair'];
...
let usernames1 = ['admin', 'Faisal', 'Riaz', 'Kamran', 'Zubair'];
...
const current_users = ['Anas', 'Faisal', 'admin', 'Kaif', 'Subhan'];
// Make a list of new usernames
const new_users = ['Taha', 'Yasir', 'Jabbar', 'kazi', 'Subhan'];
...
const favorite_pizzas = ['Bihari tikka', 'Fajita', 'BBQ Chicken'];
...
const common_animals = ['Dog', 'Cat', 'Rabbit'];
...
// Create an array of magician's names
const magicianNames2 = ['Merlin', 'Houdini', 'David Copperfield', 'Penn', 'Teller'];
...
// Create an array of magician's names
const magicianNames3 = ['Merlin', 'Houdini', 'David Copperfield', 'Penn', 'Teller'];
...
function createCar(manufacturer, modelName, options) {
    const carInfo = Object.assign({ manufacturer: manufacturer, modelName: modelName }, options);
    return carInfo;
}
